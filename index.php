...
if(isset($_POST['submit'])){
    ...
    $sql="insert into student_data values('$student_id' , '$first_name' , '$last_name' , ' $gender' , ' $class')";
...
<div class="form-group">
    <lable>Class</lable>
       <input type="text" class="form-control"  placeholder="Enter your class" name="class_name">
</div>
